(module
  ...
  (func (;20;) (type 0) (param i32 i32)
    ...
    call 16
    unreachable)
  (func (;21;) (type 5) (param i32 i32 i32 i32) (result i32)
    block  ;; label = @1
      local.get 2
      i32.const 1114112
      i32.eq
  ...
  (export "smart_nft_view_command" (func 29))
  (export "__wbindgen_add_to_stack_pointer" (func 37))
  (export "__wbindgen_malloc" (func 19))
  (export "__wbindgen_realloc" (func 22))
  (export "__wbindgen_free" (func 27))
  (elem (;0;) (i32.const 1) func 36 15 24 18 7 38 31 32 34 17 33 39 23 14 9 12 41)
