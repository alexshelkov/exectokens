(module
  ...
  (func (;15;) (type 8) (param i32 i32 i32 i32)
    ...
    i32.const 1
    i32.store)
  (func (;16;) (type 11) (param i32 i32 i32 i32 i32 i32)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (func (;23;) (type 0) (param i32 i32)
    ...
    call 19
    unreachable)
  (func (;24;) (type 9) (param i32 i32 i32 i32) (result i32)
    block  ;; label = @1
      local.get 2
      i32.const 1114112
      i32.eq
    ...
    i32.load offset=12
    call_indirect (type 1))
  (func (;25;) (type 12) (param i32 i32 i32 i32 i32 i32) (result i32)
    local.get 0
    i32.eqz
    if  ;; label = @1
      call 47
  ...
  (func (;27;) (type 10) (param i32 i32 i32 i32 i32) (result i32)
    local.get 0
    i32.eqz
    if  ;; label = @1
      call 47
  ...
  (func (;28;) (type 6) (param i32 i32 i32 i32 i32)
    local.get 0
    i32.eqz
    if  ;; label = @1
      call 47
  ...
  (func (;29;) (type 13) (param i32 i32 i64 i32 i32)
    local.get 0
    i32.eqz
    if  ;; label = @1
      call 47
  ...
  (func (;30;) (type 15) (param i32 i32 f64 i32 i32)
    local.get 0
    i32.eqz
    if  ;; label = @1
      call 47
  ...
  (func (;31;) (type 17) (param i32 i32 f32 i32 i32)
    local.get 0
    i32.eqz
    if  ;; label = @1
      call 47
  ...
  (export "smart_nft_view_canvas_get_buffer" (func 52))
  (export "smart_nft_view_canvas_get_height" (func 53))
  (export "smart_nft_view_canvas_get_scale" (func 54))
  (export "smart_nft_view_canvas_get_tick" (func 55))
  (export "smart_nft_view_canvas" (func 10))
  (export "smart_nft_view_name" (func 22))
  (export "smart_nft_view_canvas_get_width" (func 53))
  (export "__wbindgen_add_to_stack_pointer" (func 46))
  (export "__wbindgen_free" (func 37))
  (elem (;0;) (i32.const 1) func 45 18 34 21 8 48 40 41 43 20 42 49 26 17 11 14 51 32 28 28 27 16 27 25 33 28 31 30 29)
  (data (;0;) (i32.const 1048576) "Canvas\00\00\03\00\00\00\0c\00\00\00\04\00\00\00\04\00\00\00\05\00\00\00\06\00\00\00/rust/deps/dlmalloc-0.2.6/src/dlmalloc.rsassertion failed: psize >= size + min_overhead\00 \00\10\00)\00\00\00\a8\04\00\00\09\00\00\00assertion failed: psize <= size + max_overhead\00\00 \00\10\00)\00\00\00\ae\04\00\00\0d\00\00\00memory allocation of  bytes failed\00\00\c8\00\10\00\15\00\00\00\dd\00\10\00\0d\00\00\00std/src/alloc.rs\fc\00\10\00\10\00\00\00c\01\00\00\09\00\00\00\03\00\00\00\0c\00\00\00\04\00\00\00\07\00\00\00\00\00\00\00\08\00\00\00\04\00\00\00\08\00\00\00\00\00\00\00\08\00\00\00\04\00\00\00\09\00\00\00\0a\00\00\00\0b\00\00\00\0c\00\00\00\0d\00\00\00\10\00\00\00\04\00\00\00\0e\00\00\00\0f\00\00\00\10\00\00\00\11\00\00\00capacity overflow\00\00\00t\01\10\00\11\00\00\00alloc/src/raw_vec.rs\90\01\10\00\14\00\00\00\18\00\00\00\05\00\00\0000010203040506070809101112131415161718192021222324252627282930313233343536373839404142434445464748495051525354555657585960616263646566676869707172737475767778798081828384858687888990919293949596979899closure invoked recursively or after being dropped"))
